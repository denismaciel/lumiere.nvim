...
M.get = function(colors, opts)
    ...
    return {
        ...
        Function = util.merge(
            { fg = colors.fg, bg = bg, italic = opts.italic },
        ...
        Keyword = util.merge({ fg = colors.fg, bg = bg, bold = opts.bold }, opts.styles.keywords),
        ...
        Type = util.merge({ fg = colors.fg, bg = bg, bold = opts.bold }, opts.styles.types),
