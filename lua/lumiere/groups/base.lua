...
M.get = function(colors, opts)
    ...
    return {
        ...
        FloatTitle = { fg = colors.text, bg = colors.surface, bold = opts.bold },
        ColorColumn = { fg = colors.orange, bg = colors.orange_bg },
        Conceal = { fg = colors.text_faint, bg = bg, bold = opts.bold },
        Cursor = { reverse = true },
        CursorColumn = { bg = colors.surface_subtle },
        CursorLine = { bg = colors.surface_subtle },
        CursorLineNr = { fg = colors.punctuation, bg = bg, bold = opts.bold },
        Directory = { fg = colors.text, bg = bg, bold = opts.bold },
        EndOfBuffer = { fg = bg, bg = bg },
        ErrorMsg = { fg = colors.text, bg = bg, bold = opts.bold, reverse = inverse },
        ...
        StatusLineNC = { fg = colors.text_secondary, bg = bg, underline = true, italic = opts.italic },
        Substitute = { fg = colors.text_on_accent, bg = colors.yellow, reverse = inverse },
        TabLine = { fg = colors.text_faint, bg = bg },
        TabLineFill = { bg = bg },
        TabLineSel = { fg = colors.text, bg = colors.surface_selected, bold = opts.bold },
        ...
        Search = { fg = colors.text_on_accent, bg = colors.yellow },
        IncSearch = { fg = colors.text_on_accent, bg = colors.yellow, reverse = inverse },
        CurSearch = { fg = colors.text_strong, bg = colors.none, bold = opts.bold, reverse = inverse },
        ...
        Error = { fg = colors.text, bg = bg, bold = opts.bold, reverse = inverse },
        Todo = {
            fg = colors.text,
            bg = bg,
            bold = opts.bold,
